...
void poll_data_handler(void){
  uint16_t * data = acquire_get_data();
  if(data == NULL) return;
  lv_chart_set_point_count(ui_Chart2, POINTCNT);
  lv_chart_set_ext_y_array(ui_Chart2, ui_Chart2_series_1, data);
